...
t_{Eh}=\frac{E_{0y}'}{E_{0y}}=\frac{2\cos\theta}{\cos\theta+\frac{1}{n_{21}}\frac{\eta_1}{\eta_2}\sqrt{n_{21}^2-\sin^2\theta}}\\
\end{array}
\end{equation*}
...
t_{Ev}=\frac{2\cos\theta}{\frac{\eta_1}{\eta_2}\cos\theta+\frac{1}{n_{21}}\sqrt{n_{21}^2-\sin^2\theta}}\\
\end{array}
\end{equation*}
Per incidenza dall'aria su un dielettrico
\begin{equation*}
...
\end{equation*}
Per il secondo mezzoprivo di dissipazioni
\begin{equation*}
...
Per comodità assumiamo l'onda incidente polarizzata orizzontalment $\,\Rightarrow\,$ per continuità anche l'onda rifratta lo è
\begin{equation*}
